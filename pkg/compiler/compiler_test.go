...
import (
	...
	"github.com/juanpablocruz/monkey/pkg/ast"
	"github.com/juanpablocruz/monkey/pkg/code"
	"github.com/juanpablocruz/monkey/pkg/lexer"
	"github.com/juanpablocruz/monkey/pkg/object"
	"github.com/juanpablocruz/monkey/pkg/parser"
)
...
func testConstants(
	...
	for i, constant := range expected {
		...
		case string:
			err := testSringObject(constant, actual[i])
			if err != nil {
				return fmt.Errorf("constant %d - testSringObject failed: %s", i, err)
			}
...
func testSringObject(expected string, actual object.Object) error {
